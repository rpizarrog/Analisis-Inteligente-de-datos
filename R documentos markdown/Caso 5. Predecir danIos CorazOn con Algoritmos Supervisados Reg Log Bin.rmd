...
$$
Y=β_0+β_1⋅(coeficiente)+β_2⋅(coeficiente)+β_3⋅(coeficiente)+...+β_n⋅(coeficiente)Y=β_0+β_1⋅(coeficiente)+β_2⋅(coeficiente)+β_3⋅(coeficiente)+...+β_n⋅(coeficiente)
$$

entonces ...

$$
HeartDisease_01 = -6.3411940 +BMI⋅(coeficiente) +SmokingYes\cdot(coeficiente) + ... + SkinCancerYes\cdot(coeficiente) 
$$
...
Este valor -0.6279663 significa a valor probabilístico?
...
Tiene un valor de 0.3681 es decir un 36.81%
...
Si la predicción es es 0 no tienen afección del corazón en caso se que hubiera resultado 1 entonces la predicción implicaría que si tendría daño del corazón.
