...
Cualquier observación con puntuaciones superiores al umbral se prevé como la clase positiva y las puntuaciones inferiores al umbral se prevén como la clase negativa.[@amazonmahinelearning].
...
Habiendo realizado predicciones con los datos de validación, se tiene un valor de aproximadamente del $92%$ 92% con el de exactitud en el modelo de regresión logística .
