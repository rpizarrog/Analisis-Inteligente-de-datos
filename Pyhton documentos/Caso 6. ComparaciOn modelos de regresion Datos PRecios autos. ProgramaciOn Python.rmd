...
comparaciones = comparaciones.assign(Precio_Prediccion = predicciones.flatten().tolist())
print(comparaciones)
...
```{python}
predicciones = modelo_rf.predict(X_valida)
predicciones
...
comparaciones = comparaciones.assign(Precio_Predicciones = predicciones.flatten().tolist())
