...
```{python}
model_rf = RandomForestRegressor().fit(X_entrena, Y_entrena)
```
...
Para estos datos para estos valores de entrenamiento y validación, el valor de RMSE es aproximadamente 0.75, menor que el valor de árbol de regresión en *Python* del Caso 4.
